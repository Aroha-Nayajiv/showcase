...
2. **Compliance:** PCI-DSS Level 1 compliance is mandatory, with zero raw card data touching MealCredit servers (CON-66390130AA). SOC2 Type II structural planning must be baked into the infrastructure-as-code and access control policies ([CON-81FB01F06B](../project_glossary.md#con-81fb01f06b)).
...
Beneficiary-Platform Dispute Flow ([JNY-2B038C9362](../project_glossary.md#jny-2b038c9362)): Adjudicated by the Dispute Adjudicator (ACT-7BA340FF76) using evidence from the Data Persistence Layer (SUR-FA61592CD4).
