...
So that the platform complies with data residency and jurisdictional compliance requirements (CON-30EA97016B, [CON-9B82D67FAF](../project_glossary.md#con-9b82d67faf)) and ensures that no PII can ever be linked back to the anonymous voucher ID.
...
The offboarding process must ensure strict PII purging and data retention policies, aligning with the project's commitment to absolute anonymization and data isolation (CON-0A0288EED4, [CON-92F07E31B0](../project_glossary.md#con-92f07e31b0)).
