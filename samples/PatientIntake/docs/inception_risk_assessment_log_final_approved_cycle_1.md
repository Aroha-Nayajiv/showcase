...
### NFR-001: Response time <200 ms for form load and submission under typical load.
### NFR-002: System availability ≥99.9% monthly.
### NFR-003: Data at rest encryption must meet AES‑256 (FIPS‑140‑2 Level 1).
### NFR-004: Transport security must use TLS 1.3 with forward secrecy.
### NFR-005: Audit log storage must be append‑only and tamper‑evident; retention ≥7 years.
...
## Success Metrics
- Completeness ≥99.5% of all CRUD operations captured in audit logs.
- 100% of PHI fields encrypted at rest and in transit.
- Zero unauthorized data disclosures in quarterly security audits.
