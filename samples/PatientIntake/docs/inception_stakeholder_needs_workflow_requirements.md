...
5. **Strategic Objective 4 – Stakeholder Satisfaction**: Attain a minimum patient satisfaction score of 90 % for the intake experience (survey‑based) and a staff satisfaction score of 85 % for workflow efficiency. These metrics are captured monthly and reported to the governance board.
