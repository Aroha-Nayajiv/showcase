...
### REQ-002: Transport security
All client‑server communication shall use TLS 1.3 with forward secrecy. Acceptance: SSL Labs A+ rating; connections using TLS 1.0/1.1/1.2 are rejected.
